              ...
              <form onSubmit={handleSubmit} className='space-y-3'>
                <div>
                  ...
                  <input
                    ...
                    className='block w-full px-3 py-1.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple/20 focus:border-brand-purple'
                  />
                </div>
                <div>
                  <label className='block text-xs font-medium text-gray-500 mb-1.5'>
                ...
                <button
                  ...
                  className='w-full px-4 py-2 rounded-lg text-sm font-medium text-white bg-brand-purple hover:bg-brand-purple-dark disabled:opacity-50 transition-colors'
                >
